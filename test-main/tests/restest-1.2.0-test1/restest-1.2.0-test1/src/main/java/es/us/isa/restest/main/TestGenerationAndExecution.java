...
public class TestGenerationAndExecution {
	...
	//private static String propertiesFilePath = "src/test/resources/Petstore/petstore.properties";

	//private static String propertiesFilePath = "src/test/resources/PetstoreMin/petstore.properties";
	//private static String propertiesFilePath = "src/test/resources/Bikewise/bikewise.properties";

	//workspace
	//private static String propertiesFilePath = "src/test/resources/my-jhpetclinic-from-jdl/petstore.properties"; //anda

	private static String propertiesFilePath = "src/test/resources/scooter/scooter.properties";
